...
class TrainingData :
 ...
 public:
  ...
  // string hints = 9;
  void clear_hints();
  static const int kHintsFieldNumber = 9;
  ...
  static const int kPlayedTimeFieldNumber = 5;
  ...
  private:
  bool has_transcript_identity() const;
  public:
  void clear_transcript_identity();
  static const int kTranscriptIdentityFieldNumber = 3;
...
class StreamingTrainingRequest :
 ...
 public:
  ...
  void Swap(StreamingTrainingRequest* other);
  ...
  void clear_media_identity();
  static const int kMediaIdentityFieldNumber = 4;
  const std::string& media_identity() const;
  void set_media_identity(const std::string& value);
  void set_media_identity(std::string&& value);
  void set_media_identity(const char* value);
...
// string transcript_identity = 3;
inline bool TrainingData::has_transcript_identity() const {
...
// bytes payload = 7;
inline bool TrainingData::has_payload() const {
...
// bytes audio_content = 2;
inline bool StreamingTrainingRequest::has_audio_content() const {
