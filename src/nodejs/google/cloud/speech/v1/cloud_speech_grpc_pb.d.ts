...
export interface ISpeechClient {
    recognize(request: google_cloud_speech_v1_cloud_speech_pb.RecognizeRequest, callback: (error: Error | null, response: google_cloud_speech_v1_cloud_speech_pb.RecognizeResponse) => void): grpc.ClientUnaryCall;
    recognize(request: google_cloud_speech_v1_cloud_speech_pb.RecognizeRequest, metadata: grpc.Metadata, callback: (error: Error | null, response: google_cloud_speech_v1_cloud_speech_pb.RecognizeResponse) => void): grpc.ClientUnaryCall;
    recognize(request: google_cloud_speech_v1_cloud_speech_pb.RecognizeRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: Error | null, response: google_cloud_speech_v1_cloud_speech_pb.RecognizeResponse) => void): grpc.ClientUnaryCall;
    longRunningRecognize(request: google_cloud_speech_v1_cloud_speech_pb.LongRunningRecognizeRequest, callback: (error: Error | null, response: google_longrunning_operations_pb.Operation) => void): grpc.ClientUnaryCall;
    longRunningRecognize(request: google_cloud_speech_v1_cloud_speech_pb.LongRunningRecognizeRequest, metadata: grpc.Metadata, callback: (error: Error | null, response: google_longrunning_operations_pb.Operation) => void): grpc.ClientUnaryCall;
    longRunningRecognize(request: google_cloud_speech_v1_cloud_speech_pb.LongRunningRecognizeRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: Error | null, response: google_longrunning_operations_pb.Operation) => void): grpc.ClientUnaryCall;
...
export class SpeechClient extends grpc.Client implements ISpeechClient {
    ...
    public recognize(request: google_cloud_speech_v1_cloud_speech_pb.RecognizeRequest, callback: (error: Error | null, response: google_cloud_speech_v1_cloud_speech_pb.RecognizeResponse) => void): grpc.ClientUnaryCall;
    public recognize(request: google_cloud_speech_v1_cloud_speech_pb.RecognizeRequest, metadata: grpc.Metadata, callback: (error: Error | null, response: google_cloud_speech_v1_cloud_speech_pb.RecognizeResponse) => void): grpc.ClientUnaryCall;
    public recognize(request: google_cloud_speech_v1_cloud_speech_pb.RecognizeRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: Error | null, response: google_cloud_speech_v1_cloud_speech_pb.RecognizeResponse) => void): grpc.ClientUnaryCall;
    public longRunningRecognize(request: google_cloud_speech_v1_cloud_speech_pb.LongRunningRecognizeRequest, callback: (error: Error | null, response: google_longrunning_operations_pb.Operation) => void): grpc.ClientUnaryCall;
    public longRunningRecognize(request: google_cloud_speech_v1_cloud_speech_pb.LongRunningRecognizeRequest, metadata: grpc.Metadata, callback: (error: Error | null, response: google_longrunning_operations_pb.Operation) => void): grpc.ClientUnaryCall;
    public longRunningRecognize(request: google_cloud_speech_v1_cloud_speech_pb.LongRunningRecognizeRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: Error | null, response: google_longrunning_operations_pb.Operation) => void): grpc.ClientUnaryCall;
