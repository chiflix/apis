...
export interface ITranslationClient {
    ...
    processOrder(request: translation_v1_translation_pb.ProcessOrderRequest, callback: (error: Error | null, response: translation_v1_translation_pb.ProcessOrderResponse) => void): grpc.ClientUnaryCall;
    processOrder(request: translation_v1_translation_pb.ProcessOrderRequest, metadata: grpc.Metadata, callback: (error: Error | null, response: translation_v1_translation_pb.ProcessOrderResponse) => void): grpc.ClientUnaryCall;
    processOrder(request: translation_v1_translation_pb.ProcessOrderRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: Error | null, response: translation_v1_translation_pb.ProcessOrderResponse) => void): grpc.ClientUnaryCall;
...
export class TranslationClient extends grpc.Client implements ITranslationClient {
    ...
    public processOrder(request: translation_v1_translation_pb.ProcessOrderRequest, callback: (error: Error | null, response: translation_v1_translation_pb.ProcessOrderResponse) => void): grpc.ClientUnaryCall;
    public processOrder(request: translation_v1_translation_pb.ProcessOrderRequest, metadata: grpc.Metadata, callback: (error: Error | null, response: translation_v1_translation_pb.ProcessOrderResponse) => void): grpc.ClientUnaryCall;
    public processOrder(request: translation_v1_translation_pb.ProcessOrderRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: Error | null, response: translation_v1_translation_pb.ProcessOrderResponse) => void): grpc.ClientUnaryCall;
