...
public protocol Google_Cloud_Speech_V1_SpeechService {
  ...
  func longRunningRecognize(_ request: Google_Cloud_Speech_V1_LongRunningRecognizeRequest, callOptions: CallOptions?) -> UnaryCall<Google_Cloud_Speech_V1_LongRunningRecognizeRequest, GoogleLongrunningModel.Google_Longrunning_Operation>
...
public final class Google_Cloud_Speech_V1_SpeechServiceClient: GRPCClient, Google_Cloud_Speech_V1_SpeechService {
  ...
  ///   - callOptions: Call options; `self.defaultCallOptions` is used if `nil`.
  /// - Returns: A `UnaryCall` with futures for the metadata, status and response.
  public func longRunningRecognize(_ request: Google_Cloud_Speech_V1_LongRunningRecognizeRequest, callOptions: CallOptions? = nil) -> UnaryCall<Google_Cloud_Speech_V1_LongRunningRecognizeRequest, GoogleLongrunningModel.Google_Longrunning_Operation> {
...
public protocol Google_Cloud_Speech_V1_SpeechProvider: CallHandlerProvider {
  ...
  func longRunningRecognize(request: Google_Cloud_Speech_V1_LongRunningRecognizeRequest, context: StatusOnlyCallContext) -> EventLoopFuture<GoogleLongrunningModel.Google_Longrunning_Operation>
