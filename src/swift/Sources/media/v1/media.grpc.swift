...
public protocol Sagittarius_Media_V1_MediaService {
  ...
  func updateThumbnail(_ request: Sagittarius_Media_V1_UpdateThumbnailRequest, callOptions: CallOptions?) -> UnaryCall<Sagittarius_Media_V1_UpdateThumbnailRequest, GoogleRPCModel.Google_Rpc_Status>
}
...
public final class Sagittarius_Media_V1_MediaServiceClient: GRPCClient, Sagittarius_Media_V1_MediaService {
  ...
  ///   - callOptions: Call options; `self.defaultCallOptions` is used if `nil`.
  /// - Returns: A `UnaryCall` with futures for the metadata, status and response.
  public func updateThumbnail(_ request: Sagittarius_Media_V1_UpdateThumbnailRequest, callOptions: CallOptions? = nil) -> UnaryCall<Sagittarius_Media_V1_UpdateThumbnailRequest, GoogleRPCModel.Google_Rpc_Status> {
...
public protocol Sagittarius_Media_V1_MediaProvider: CallHandlerProvider {
  ...
  func updateThumbnail(request: Sagittarius_Media_V1_UpdateThumbnailRequest, context: StatusOnlyCallContext) -> EventLoopFuture<GoogleRPCModel.Google_Rpc_Status>
}
